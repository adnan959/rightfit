...
const order1: SubmissionWithRelations = {
  ...
  current_role: "Product Manager at TechCorp Inc. Leading a team of 8 engineers on the mobile app platform. Responsible for roadmap planning and stakeholder management.",
...
const order2: SubmissionWithRelations = {
  ...
  current_role: "Senior Marketing Manager at BrandCo. Managing $2M annual budget across digital and traditional channels. Team of 5 direct reports.",
...
const order3: SubmissionWithRelations = {
  ...
  timeline: "1_2_months",
  location: "Chicago, IL",
  current_role: "Accountant at MidSize Corp. 3 years of experience in financial reporting and analysis. Looking to transition into investment analysis.",
...
const order4: SubmissionWithRelations = {
  ...
  timeline: "immediately",
  location: "Austin, TX",
  current_role: "Senior Account Executive at SaaS Corp. Managing enterprise accounts with $2M+ annual value. Consistently exceeding quota by 120%+.",
...
const order5: SubmissionWithRelations = {
  ...
  timeline: "3_4_months",
  location: "Seattle, WA",
  current_role: "Data Analyst at DataTech. Building dashboards and insights for product team. Managing data pipeline for 10M+ daily events.",
...
const order6: SubmissionWithRelations = {
  ...
  timeline: "exploring",
  location: "Denver, CO",
  current_role: "Store Manager at Retail Corp. Managing team of 20+ employees. Responsible for $5M annual revenue.",
